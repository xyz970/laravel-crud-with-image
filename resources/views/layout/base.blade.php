...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('third-party/filepond/dist/filepond-plugin-image-preview.min.css') }}" type="text/css">
...
<script>
    ...
    */
        ...
        columns: [
            ...
            //    `<img src="{{asset('assets/img/upload/')}}" height="100" alt="">`
            // ),
            formatter: (img) => gridjs.html(`<center><img src='{{asset('assets/img/students-photo/')}}/${img}' height="300" /></center>`)
        },
